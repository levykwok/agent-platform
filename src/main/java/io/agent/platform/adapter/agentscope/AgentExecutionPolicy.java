...
public record AgentExecutionPolicy(
    ...
    public static AgentExecutionPolicy from(AgentDefinition definition) {
        ...
        return new AgentExecutionPolicy(
                ...
                number(runtime, root, "root_timeout_ms", 180_000L, 1_000L, 1_800_000L),
                integer(runtime, root, "root_max_agent_calls", 20, 1, 100),
                number(runtime, root, "root_max_tokens", 100_000L, 100L, 10_000_000L),
                integer(runtime, root, "root_max_depth", 6, 1, 20),
