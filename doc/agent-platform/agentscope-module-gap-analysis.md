...
本文对照 模块清单，说明每个模块在 AgentScope Java / Harness 中已有的实现、当前平台已接入情况、缺口，以及推荐调用方式。
...
```text
src/main/java/io/agent/platform/runtime/AgentRuntimeService.java
src/main/java/io/agent/platform/adapter/agentscope/AgentScopeHarnessFactory.java
src/main/java/io/agent/platform/adapter/agentscope/AgentCapabilityAssembler.java
src/main/java/io/agent/platform/control/PlatformConfigStore.java
src/main/java/io/agent/platform/web/AgentRunsCompatibilityController.java
```
...
```text
doc/agent-platform/agentscope-session.md
```
...
```text
doc/agent-platform/agentscope-memory.md
```
